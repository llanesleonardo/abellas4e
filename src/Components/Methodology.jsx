  ...
  return (
    <div id='method' className='relative bg-[white] py-[100px]'>
      <div className="flex items-center justify-center relative pb-5">
        <div className="container mx-auto text-center md:text-left pb-[25px] md:pb-[50px]">
          <h1 className="text-[#9598e9] text-4xl  md:text-6xl font-bold mb-0">{t('Methodology')}</h1>
        </div>
      </div>
      <div className="flex-col justify-center items-center flex-wrap mx-2 md:flex md:justify-end md:items-start md:gap-[100px] ">
          <div className="md:flex-1 md:flex-col  md:justify-center  md:items-center">
            ...
            <div className='flex-col justify-center items-center py-5 md:flex md:justify-around md:items-center md:gap-20 md:py-10'>
