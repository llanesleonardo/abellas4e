...
const ContactFormReusablephr = () => {
    ...
    try {
      ...
      const objectValues ={
        ...
        "merge_fields": {
          ...
          "MMERGE8": '',
          "MMERGE7": '',
          "MMERGE6": 'PADRESCONHIJOSENRIESGO'
        }
      }
  ...
  return (
    ...
    <h1 className="text-[#111019] text-4xl md:text-5xl font-bold text-center mb-12">
            {t('Únete al grupo de ')} <br/>
            {t('padres con hijos en riesgo')}
       </h1> 
    ...
    <p className='text-[#000]'> o llamame al <a href="tel:+1 (520) 273-3455" className="text-[#9598e9] font-bold">(520) 273-3455</a></p>
    <p className='text-[#000]'> o escribe a <a href="mailto:anabellasforever@gmail.com" className="text-[#9598e9] font-bold">anabellasforever@gmail.com</a></p>
    </div>
  );
};

export default ContactFormReusablephr;
